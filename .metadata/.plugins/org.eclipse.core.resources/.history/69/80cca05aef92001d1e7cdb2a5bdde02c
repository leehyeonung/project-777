...
<jsp:include page="../layout/header.jsp"></jsp:include>
	<div class="bookDetail">
		...
		<div class="abcd">
			<div class="pyoji">
				<img src="/upload/${fn:replace(fList.save_dir,'\\','/')}/${fList.uuid}_th_${fList.file_name}" style="list-style:none;">
			</div>
			<div class="seoji">
				...
				<div class="qty">
					...
					<div class="arrow">
						<a href="#"><img src="/resources/images/up.png" class="upArrow" alt="upArrow"></a>
						 <a href="#"><img src="/resources/images/down.png" class="downArrow" alt="downArrow"></a><br>
						<br>
					</div>
				</div>
