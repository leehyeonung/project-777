   ...
   <div class="main">
      ...
      <div class="select">
         <table class="mypage-left">
            ...
            <tr>
               <td>
                  <a href="/mem/modify" class="box">회원정보수정</a>
               </td>
            </tr>
            <tr>
               <td>
                  <a href="/mem/orderCheck?mem_num=${ses.mem_num}">주문/배송조회</a>
               </td>
            </tr>
            <tr>
               <td>
                  <a href="/mem/buyCheck?mem_num=${ses.mem_num}">구매함</a>
               </td>
            </tr>
            <tr>
               <td>
                  <a href="/board/list" class="box">1대1문의</a>
               </td>
            </tr>
            <tr>
               <td>
                  <a href="/mem/delete" class="box Withdrawal">회원탈퇴</a>
               </td>
            </tr>
         </table>
      </div>
                           ...
                           <c:when test="${ses.mem_auth == '0'|| ses.mem_id == board.brd_writer}">
                              <tbody>
                                 <tr>
                                    ...
                                    <td>
                                       <a href="/board/boardDetail?brd_num=${board.brd_num}">${board.brd_title}</a>
                                    </td>
                  ...
                  <div class="boardRegisterBox">
                     <form action="/board/register" method="post">
                        <div class="brd_category">
                           <label for="brd_category">카테고리</label>
                           <select name="brd_category">
                              <option>질문</option>
                              <option>자유</option>
                              <option>테스트</option>
                           </select>
