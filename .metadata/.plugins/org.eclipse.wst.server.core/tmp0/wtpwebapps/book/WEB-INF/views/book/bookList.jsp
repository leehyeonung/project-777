		...
		<c:forEach items="${list}" var="list">
			<div class="box">
				...
				<div class="right">
					...
					<div class="btnBox">
						<a href="#" class="button"><button class="btn btn-outline-success">장바구니에넣기</button></a> <br> <a href="#" class="button"><button class="btn btn-outline-success">바로구매</button> <br></a>
					</div>
				</div>
			</div>
		</c:forEach>
